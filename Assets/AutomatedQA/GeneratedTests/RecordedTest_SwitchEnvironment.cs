...
{
    /// <summary>
    /// These tests were generated by Unity Automated QA for the recording: "Recordings/SwitchEnvironment.json"
    /// You can regenerate this file from the Unity Editor Menu: Tools > Automated QA > Generate Recorded Tests
    /// </summary>
    public class RecordedTest_SwitchEnvironment : RecordedTestSuite
    {
        [UnitySetUp]
        public IEnumerator SaveSetup()
        {
            var data = Application.dataPath + "/Tests/UI Test Data/DataSwitch";
        ...
        /// </summary>
        [UnityTest]
        [RecordedTest("Recordings/SwitchEnvironment.json")]
